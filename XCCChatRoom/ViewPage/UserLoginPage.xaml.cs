...
public partial class UserLoginPage : ContentPage
{
    ...
    private async Task SwitchToLoginSuccessfulStyle(XFEChatRoom_UserInfoForm userInfo)
    {
        ...
        UserInfoPage.IsLoginSuccessful = true;
        UserInfoPage.StaticUserName = userInfo.Aname;
        UserInfoPage.StaticUUID = userInfo.ID;
        UserInfoPage.StaticMail = userInfo.Amail;
        UserInfoPage.StaticPhoneNum = userInfo.Atel;
        UserInfoPage.StaticPassword = userInfo.Apassword;
        UserInfoPage.SaveUserData(this);
        ...
        {
            UserInfoPage.Current.charLabel.SetBinding(Label.TextProperty, new Binding("UserName[0]", source: UserInfoPage.Current));
            UserInfoPage.Current.nameLabel.SetBinding(Label.TextProperty, new Binding("UserName", source: UserInfoPage.Current));
            UserInfoPage.Current.UserName = userInfo.Aname;
            UserInfoPage.Current.UUID = userInfo.ID;
            UserInfoPage.CurrentUser = userInfo;
